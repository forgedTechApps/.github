...
If any item is unclear, stop — do not implement anything yet. Ask for clarification on unclear items before proceeding.
...
If conflicts with prior architectural decisions, stop and discuss first.
